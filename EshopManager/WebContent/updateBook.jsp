    ...
    <div class="content">
       <div class="header">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="index.jsp">查看图书</a> <span class="divider">/</span></li>
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="tab">
		        <label>书籍名称</label>
		        <input type="book_name"  class="input-xlarge">
		         <label>书籍分类</label>
		         ...
		         <select class="form-control" name="type_parentId">
		        ...
		        <label>本店售价</label>
		        <input type="book_price" value="90.00" class="input-xlarge">
		        <label>市场价格</label>
		        <input type="book_price_old" value="100.oo" class="input-xlarge">
		        <label>作者</label>
		        <input type="book_author" value="Smith" class="input-xlarge">
		        <label>出版社</label>
		        <input type="book_press" value="人民出版社" class="input-xlarge">
		    </form>
      </div>
